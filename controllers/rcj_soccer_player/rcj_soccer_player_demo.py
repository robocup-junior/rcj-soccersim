...
while robot.step(TIME_STEP) != -1:
    if receiver.getQueueLength() > 0:
        ...
        #print('Ball Position:', data['ball'])
        
        #####################
        ###   Blue Team   ###
        #####################

        # Move only the B1 robot 
        if name.upper() == 'B1':
        ...
        # Move only the B3 robot - goal keeper 
        if name.upper() == 'B3':
            ...
            # If the robot has the ball right in front of it, rotate, otherwise
            # stop
            if degrees >= 345 or degrees <= 15:
                multiplier = -1 if degrees < 180 else 1
                left_speed = multiplier * 4
        ...
        if name.upper() == 'Y1':
            ...
            if degrees >= 345 or degrees <= 15:
                ...
                multiplier = -1 if degrees < 180 else 1
                left_speed = multiplier * 5
                right_speed = multiplier * -5
