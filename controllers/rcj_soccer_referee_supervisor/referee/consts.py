...
OBSTACLE_TRANSLATIONS = {
    "blue": [
        { # all right
            "B1": [0.7, OBJECT_DEPTH, -0.148292],
            "B2": [0.7, OBJECT_DEPTH, -0.0417385],
            "B3": [0.7, OBJECT_DEPTH, 0.0626583]
        },
        { # all left
            "B1": [0.7, OBJECT_DEPTH, -0.0626583],
            "B2": [0.7, OBJECT_DEPTH, 0.0417385],
            "B3": [0.7, OBJECT_DEPTH, 0.148292]
        },
        { # two right, one left
            "B1": [0.7, OBJECT_DEPTH, -0.148292],
            "B2": [0.7, OBJECT_DEPTH, -0.0417385],
        ...
        { # one left, one right, one in front
            "B1": [0.7, OBJECT_DEPTH, -0.148292],
            "B2": [0.488733, OBJECT_DEPTH, 0],
            "B3": [0.7, OBJECT_DEPTH, 0.148292]
        },
        { # one middle back, one right in front, one left in front
            "B1": [0.488733, OBJECT_DEPTH, -0.148292],
            "B2": [0.7, OBJECT_DEPTH, 0],
            "B3": [0.488733, OBJECT_DEPTH, 0.148292]
        },
        {  # all middle front
            "B1": [0.55, OBJECT_DEPTH, -0.10294],
            "B2": [0.55, OBJECT_DEPTH, 0],
            "B3": [0.55, OBJECT_DEPTH, 0.10294]
        },
    ],
    "yellow": [
        {  # all right
...
YELLOW_BOT_FACING_TRANSLATION = {
    "blue": [-0.419754, OBJECT_DEPTH, 0],
    "yellow": [0.419754, OBJECT_DEPTH, 0],
}
...
ROBOT_INITIAL_TRANSLATION = {
    ...
    "Y3": [-0.419754, OBJECT_DEPTH, -0.0515446],
}
